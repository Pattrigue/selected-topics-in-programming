...
private: // hide the private data:
    ...
    void move(polygon& other) noexcept;
    size_t count = 0;  // store the number of points
    point* points = nullptr; // points to data in a contiguous piece of memory ("array" of unknown size)
}; // polygon

...
static_assert(!is_bool_v<uint8_t*>, "pointer to uint8_t is not a number");
static_assert(!is_bool_v<int*>, "pointer to int is not a number");
static_assert(!is_bool_v<int[2]>, "array of int is not a number");
static_assert(!is_bool_v<char>, "char is not a number");
